...
public class CardImagePagerAdapter extends PagerAdapter implements CardAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        Logger.d("BannerImageSize", "::"+ Utilities.getResizeImgURL(mContext, imageList.get(position).get("vImage"),
                bannerWidth,
                bannerHeight));

        Picasso.get()
                .load(Utilities.getResizeImgURL(mContext, imageList.get(position).get("vImage"),
                                bannerWidth,
                                bannerHeight))
                .fit()
