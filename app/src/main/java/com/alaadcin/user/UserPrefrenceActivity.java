...
public class UserPrefrenceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Picasso.get().load(Utilities.getResizeImgURL(getActContext(), vImageDeliveryPref, imageWidth, imageWidth)).placeholder(R.mipmap.ic_no_icon).error(R.mipmap.ic_no_icon).into(iv_preferenceImg);
