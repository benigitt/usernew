...
import com.alaadcin.user.AddAddressActivity;
...
import com.alaadcin.user.CouponActivity;
import com.alaadcin.user.ListAddressActivity;
import com.alaadcin.user.MyWalletActivity;
import com.alaadcin.user.PrescriptionActivity;
import com.alaadcin.user.ProfilePaymentActivity;
                        ...
                        /*if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                            if (Environment.isExternalStorageManager()) {
                                ...
                                try {
                                    ...
                                    startActivityForResult(intent, MANAGE_APP_ALL_FILES_ACCESS_REQUEST_CODE);
                                } catch (Exception e) {
