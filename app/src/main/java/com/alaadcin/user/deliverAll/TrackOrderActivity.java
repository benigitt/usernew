...
import com.alaadcin.user.BaseActivity;
...
import com.alaadcin.user.QuickPaymentActivity;
...
//                            Logger.d("messageStr", "INside OrderDelivered::" + messageStr);
                            ...
                            if (Utils.checkText(vImageDeliveryPref_)) {
                                Picasso.get().load(Utilities.getResizeImgURL(getActContext(), vImageDeliveryPref_, imageWidth, imageWidth)).placeholder(R.mipmap.ic_no_icon).error(R.mipmap.ic_no_icon).into(iv_preferenceImg);
