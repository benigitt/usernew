...
import com.alaadcin.user.deliverAll.AddBasketActivity;
import com.alaadcin.user.deliverAll.CheckOutActivity;
import com.alaadcin.user.deliverAll.FoodRatingActivity;
import com.alaadcin.user.deliverAll.SearchFoodActivity;
...
//        searchImgView = findViewById(R.id.searchImgView);
    ...
    private void enableSafety(String Restaurant_Safety_URL, String Restaurant_Safety_Icon) {
        ...
        String imageURL = Utilities.getResizeImgURL(getActivity(), Restaurant_Safety_Icon, grid, grid);
