...
import com.alaadcin.user.AdditionalChargeActivity;

import com.alaadcin.user.AccountverificationActivity;
import com.alaadcin.user.BuildConfig;
import com.alaadcin.user.CarWashBookingDetailsActivity;
import com.alaadcin.user.CommonDeliveryTypeSelectionActivity;
import com.alaadcin.user.LauncherActivity;
import com.alaadcin.user.MainActivity;
import com.alaadcin.user.MaintenanceActivity;
import com.alaadcin.user.NetworkChangeReceiver;
import com.alaadcin.user.OnGoingTripDetailsActivity;
import com.alaadcin.user.R;
import com.alaadcin.user.RideDeliveryActivity;
import com.alaadcin.user.UberXActivity;
import com.alaadcin.user.UberXHomeActivity;
import com.alaadcin.user.deliverAll.FoodDeliveryHomeActivity;
import com.alaadcin.user.deliverAll.ServiceHomeActivity;
import com.alaadcin.user.deliverAll.TrackOrderActivity;
